<%-- 
    ...
    Created on : 18/05/2019, 9:42:12 PM
    Author     : chenyizhe
--%>
            ...
            <div class="row content">
              ...
              <%-- main body --%>
                <div class="col-sm-8 text-center fontcolor">
                    <h1 class="fontcolory">Delete Current Members</h1>
                    <%-- search movie --%>
                    <form action="deleteMember.jsp" id="login_form" method="post">
                        ...
                        <br>
                        <br>
                        <a href="deleteMember.jsp"   id="submit_btn" class="btn btn-danger btn-lg">View All Members</a>
                        </div>
                    </form>
                    ...
                    <table class="table table-dark movies">
                        ...
                        <tr>
                            ...
                            <td><a style="color:red" href="<%=request.getContextPath()%>/deleteMemberAction.jsp?memail=<%=member.getEmail()%>">Delete Member</a></td>
