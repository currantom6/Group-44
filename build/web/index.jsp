...
<%
  //Get the absolute path where the xml is located. So those class can get and edit the data.
  if (WriteXml.path == null){
      WriteXml.path = application.getRealPath("");
  }
  if (ReadXml.path == null){
      ReadXml.path = application.getRealPath("");
  }
  ...
  <div class="row content">
    ...
    <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
      ...
      <span class="sr-only">Next</span>
        ...
        <a href="index.jsp" class="btn btn-lg btn-danger">View All Movies</a>
        </div>
        <br>
        <%-- Team information --%>
        <hr>
