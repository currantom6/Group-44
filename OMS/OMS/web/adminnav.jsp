<%-- 
    Document   : adminnav
    Created on : 18/05/2019, 5:19:59 PM
    Author     : chenyizhe
--%>
    ...
    <body>
        ...
        <nav class="navbar navbar-inverse">
            ...
            <ul class="nav navbar-nav btn navbar-right">
                ...
                <li><a href ="<%=request.getContextPath()%>/adminCenter.jsp">Admin</a></li>
                <li><a href ="<%=request.getContextPath()%>/manageMovie.jsp">Manage</a></li>
                <li><a href ="<%=request.getContextPath()%>/account.jsp">Account</a></li>
                <li><a href ="<%=request.getContextPath()%>/logbook.jsp">LogBook</a></li>
            </ul>
            </div>
        </nav>
    </body>
