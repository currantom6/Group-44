            ...
            <div class="row content">
              ...
              <%-- main body --%>
                <div class="col-sm-8 text-center fontcolor">
                    <h1 class="fontcolory">Delete Current Movies</h1>
                    <%-- search movie --%>
                    <form action="deleteMovie.jsp" id="login_form" method="post">
                        ...
                        <br>
                        <br>
                        <a href="deleteMovie.jsp" id="submit_btn" class="btn btn-danger btn-lg">View All Movies</a>
                        </div>
                    </form>
                    ...
                    <%-- movie List --%>
                            ...
                            <% if (v.isStatus()){ %>
                            <a class="btn btn-danger" href="<%=request.getContextPath()%>/deleteMovieAction.jsp?vtitle=<%=v.getTitle()%>">Delete Movie</a>
                            <% }else{ %>
                            <button type="button" class="btn btn-warning" disabled>Renting...</button>
                            <% } %>
                            </li>
                            </ul>
